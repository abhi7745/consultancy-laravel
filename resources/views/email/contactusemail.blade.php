	...
	<style>
		* {
		...
		@media (max-width:660px) {
			...
			.row-2 .column-1 .block-1.image_block img {
			...
			.row-2 .column-1 .block-1.image_block .alignment {
													...
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="padding-left:40px;padding-right:40px;width:100%;">
																<div class="alignment" align="center" style="line-height:10px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/826693_810663/mail-message-email-send-message-1454731.jpg" style="display: block; height: auto; border: 0; width: 128px; max-width: 100%;" width="128" alt="I'm an image" title="I'm an image"></div>
															</td>
														</tr>
													</table>
															...
															<td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;"><span style="font-size:30px;color:#2b303a;"><strong>You have a new message from Contact-Us form</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/826693_810663/user-avatar-user-icon-account-icon-6380868.jpg" style="display: block; height: auto; border: 0; width: 116px; max-width: 100%;" width="116" alt="I'm an image" title="I'm an image"></div>
															</td>
														</tr>
													</table>
															...
															<td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:15px;">
																<div style="font-family: sans-serif">
																	<div class style="font-size: 12px; mso-line-height-alt: 18px; color: #555555; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 27px;"><span style="color:#2b303a;font-size:18px;"><strong>{{ $mailData['name'] }}</strong></span></p>
																		<p style="margin: 0; text-align: center; mso-line-height-alt: 25.5px;"><span style="color:#2b303a;font-size:17px;">{{ $mailData['email'] }}</span></p>
																		<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 25.5px;"><span style="color:#2b303a;font-size:17px;"><a href="https://wa.me/{{ $mailData['phone'] }}">{{ $mailData['phone'] }}</a></span></p>
																	</div>
																</div>
															</td>
														</tr>
													...
													<table class="text_block block-4" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:40px;padding-left:30px;padding-right:30px;padding-top:20px;">
																<div style="font-family: sans-serif">
                                                                    <label for="">Subject : {{ $mailData['subject'] }}</label>
                                                                    <br><br>
																	<div class style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
																		<p style="margin: 0; font-size: 14px; text-align: justify; mso-line-height-alt: 22.5px;"><span style="color:#2b303a;font-size:15px;">{{ $mailData['message'] }}</span></p>
																		<!-- <p style="margin: 0; font-size: 14px; mso-line-height-alt: 18px;">&nbsp;</p>
																		<p style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 22.5px;"><span style="color:#2b303a;font-size:15px;">Thank you,</span></p>
																		<p style="margin: 0; font-size: 14px; text-align: right; mso-line-height-alt: 22.5px;"><span style="color:#2b303a;font-size:15px;">Emily Smith</span></p> -->
																	</div>
																</div>
															</td>
														</tr>
